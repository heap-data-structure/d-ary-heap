...
var title = util.format("sorted-%s (new %s(%d), %s)", arity , ctor.name, n, comparename);
...
test( title , function ( ) {
	...
	var out = itertools.list( daryheap.sorted( arity , compare , array.swap , a , 0 , n ) ) ;

	deepEqual( a.length , n , "size stays the same size" ) ;
